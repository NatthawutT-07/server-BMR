...
// const { create, deleteDetail, listDetail } = require("../controllers/admin/detail");
...
const { uploadStationCSV, uploadItemMinMaxCSV, uploadPartnersCSV, uploadMasterItemCSV, uploadSalesCSV, uploadStockCSV, uploadWithdrawCSV, uploadTamplateCSV, uploadItemSearchCSV } = require('../controllers/admin/uploadController');
// Upload endpoints
...
router.post('/upload-sales', authCheck, adminCheck, upload.single('file'), uploadSalesCSV)
...
//edit station detaill add shelf <------
// router.post("/shelf-create", authCheck, adminCheck, createShelf)
// router.delete('/row-delete/:id', authCheck, adminCheck, deleteRow);

// router.get("/shelf-row", authCheck, listShelf); //select station
//Tamplate 
